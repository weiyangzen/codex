# ConfigReadResponse Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`ConfigReadResponse` 是 **EXPERIMENTAL** App-Server Protocol v2 中定义的类型，用于Response containing full configuration with layers。
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/ConfigReadResponse.json`

### 相关类型
`ConfigReadParams`, `Config`
