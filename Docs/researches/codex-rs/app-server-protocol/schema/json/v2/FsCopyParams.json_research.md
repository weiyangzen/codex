# FsCopyParams Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`FsCopyParams` 是 App-Server Protocol v2 中定义的类型，用于Request parameters for copying files or directories。
...
**字段说明：**
`sourcePath`, `destinationPath`, `recursive`
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/FsCopyParams.json`
