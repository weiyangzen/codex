# FeedbackUploadParams Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`FeedbackUploadParams` 是 App-Server Protocol v2 中定义的类型，用于Request parameters for uploading user feedback。
...
**字段说明：**
`classification`, `reason`, `threadId`, `includeLogs`, `extraLogFiles`
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/FeedbackUploadParams.json`
