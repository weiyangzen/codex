# CommandExecWriteParams Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`CommandExecWriteParams` 是 App-Server Protocol v2 中定义的类型，用于Request parameters to write stdin to running command。
...
**字段说明：**
`processId`, `deltaBase64`, `closeStdin`
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/CommandExecWriteParams.json`

### 相关类型
`CommandExecParams`, `CommandExecWriteResponse`
