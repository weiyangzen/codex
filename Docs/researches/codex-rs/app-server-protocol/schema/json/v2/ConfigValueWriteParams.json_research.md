# ConfigValueWriteParams Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`ConfigValueWriteParams` 是 App-Server Protocol v2 中定义的类型，用于Request parameters for writing a single config value。
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/ConfigValueWriteParams.json`

### 相关类型
`ConfigWriteResponse`, `ConfigBatchWriteParams`
