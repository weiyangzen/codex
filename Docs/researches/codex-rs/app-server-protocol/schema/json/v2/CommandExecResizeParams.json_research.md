# CommandExecResizeParams Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`CommandExecResizeParams` 是 App-Server Protocol v2 中定义的类型，用于Request parameters to resize a running PTY session。
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/CommandExecResizeParams.json`

### 相关类型
`CommandExecParams`, `CommandExecResizeResponse`
