# ContextCompactedNotification Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`ContextCompactedNotification` 是 App-Server Protocol v2 中定义的类型，用于DEPRECATED notification for context compaction。
**DEPRECATED**: This notification is deprecated. Use `ContextCompaction` item type instead.


**使用场景：**
- 在 Thread Management 流程中传递数据
- 客户端与服务器之间的状态同步
- 支持相关功能的完整实现
...
该类型的核心目的是实现 Thread Management 相关的数据交换：
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/ContextCompactedNotification.json`
