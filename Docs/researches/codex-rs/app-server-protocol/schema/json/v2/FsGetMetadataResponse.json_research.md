# FsGetMetadataResponse Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`FsGetMetadataResponse` 是 App-Server Protocol v2 中定义的类型，用于Response containing file metadata。
...
**字段说明：**
`isDirectory`, `isFile`, `createdAtMs`, `modifiedAtMs`
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/FsGetMetadataResponse.json`
