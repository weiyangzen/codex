# FsCreateDirectoryParams Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`FsCreateDirectoryParams` 是 App-Server Protocol v2 中定义的类型，用于Request parameters for creating directories。
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/FsCreateDirectoryParams.json`
