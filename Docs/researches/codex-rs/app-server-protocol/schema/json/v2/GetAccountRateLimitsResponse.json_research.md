# GetAccountRateLimitsResponse Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`GetAccountRateLimitsResponse` 是 App-Server Protocol v2 中定义的类型，用于Response containing account rate limits。
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/GetAccountRateLimitsResponse.json`
