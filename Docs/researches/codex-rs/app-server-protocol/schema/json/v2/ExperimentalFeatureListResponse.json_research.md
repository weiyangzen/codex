# ExperimentalFeatureListResponse Research Document

## 1. 场景与职责 (Usage Scenario and Responsibility)

`ExperimentalFeatureListResponse` 是 App-Server Protocol v2 中定义的类型，用于Response containing list of experimental features。

**使用场景：**
- 在 Experimental Features 流程中传递数据
- 客户端与服务器之间的状态同步
- 支持相关功能的完整实现
...
该类型的核心目的是实现 Experimental Features 相关的数据交换：
...
### 生成文件
- **JSON Schema**: `/home/sansha/Github/codex/codex-rs/app-server-protocol/schema/json/v2/ExperimentalFeatureListResponse.json`

### 相关类型
`ExperimentalFeatureListParams`, `ExperimentalFeature`
...
- 与 Experimental Features 相关功能模块交互
