# Frame 27 Research Document - HBARS Animation Sequence

## 场景与职责

Frame 27 是 HBARS 动画序列的第二十七帧，位于第二阶段的后期。此帧继续展示波浪形态的演变，条块分布进一步变化，是整个 36 帧循环中第二阶段后期的重要帧。

在 36 帧循环中，Frame 27 代表了约 75% 的进度（27/36），标志着第二阶段进入后期深化阶段。
...
include_str!(concat!("../frames/", "hbars", "/frame_27.txt"))
```
